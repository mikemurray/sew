(function() {
  ...
  Worker = (function() {
    ...
    Worker.prototype._new = function() {
      if (true && (!ffs.existsSync(this.configFile) || argv.force)) {
    ...
    Worker.prototype.compileScripts = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        lib = _ref[_i];
        if (ffs.existsSync(lib)) libSources.push(fs.readFileSync(lib));
      }
      if (!this.package) {
    ...
    Worker.prototype.compileStyles = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        style = _ref[_i];
        if (ffs.existsSync(style)) styleSources.push(fs.readFileSync(style));
    ...
    Worker.prototype.readConfig = function() {
      ...
      try {
        if (ffs.existsSync(this.configFile)) {
